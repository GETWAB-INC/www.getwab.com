...
<body style="margin:0; padding:0; background:#2d2d2d;">
  ...
  <div style="display:none; max-height:0; overflow:hidden; opacity:0; color:transparent;">
    Reset your GETWAB account password.
  </div>
          ...
          <tr>
            <td style="padding:22px 24px 8px 24px; font-family:Arial, sans-serif; color:#ffffff;">
              ...
              <p style="margin:0 0 14px 0; font-size:14px; line-height:1.6; color:#ffffff;">
                Hello{{ isset($notifiable->name) ? ', ' : ', ' }}
                <strong style="color:#ffffff;">{{ $notifiable->name ?? 'there' }}</strong>.
                We received a request to reset the password for your GETWAB account.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:0 24px 18px 24px; font-family:Arial, sans-serif;">
              <p style="margin:0 0 10px 0; font-size:13px; line-height:1.6; color:#ffffff;">
                This password reset link will expire in <strong style="color:#ffffff;">60 minutes</strong>.
                If the button doesn’t work, copy and paste this URL into your browser:
              </p>

              <p style="margin:0; font-size:12px; line-height:1.6; word-break:break-all; color:#ffffff;">
                <a
                  href="{{ $url }}"
