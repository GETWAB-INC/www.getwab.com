...
.checkout-product-name, .checkout-product-price {
    font-style: normal;
...
.checkout-product-type, .checkout-product-frequency {
    font-weight: 400;
    font-size: 24px;
  line-height: 16px;
...
.checkout-cost-label, .checkout-cost-amount {
    font-weight: 400;
    font-size: 24px;
    line-height: 31px;
    color: #FFFFFF;
...
.checkout-total-label, .checkout-total-amount {
    font-weight: 600;
    font-size: 32px;
    line-height: 32px;
    color: #FFFFFF;
...
.step-3-month-select-field, .step-3-year-select-field {
  width: auto;
  height: 48px;
  flex-shrink: 0;
}
