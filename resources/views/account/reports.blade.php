    ...
    <aside class="dashboard-sidebar">
      ...
      <div class="user-info-section">
        ...
        <nav class="navigation-menu">
          <a href="{{ route('account.reports') }}" class="nav-menu-item active" data-section="reports">
            <img src="{{ asset('/img/ico/reports-ico.svg') }}" alt="" />
            Reports
          </a>
          <a href="{{ route('account.packages') }}" class="nav-menu-item" data-section="packages">
            <img src="{{ asset('/img/ico/Report-Packages-ico.svg') }}" alt="" />
            Report Packages
          </a>
          <a href="{{ route('account.subscription') }}" class="nav-menu-item" data-section="subscription">
            <img src="{{ asset('/img/ico/Subscription-ico.svg') }}" alt="" />
            Subscription
          </a>
          <a href="{{ route('account.billing') }}" class="nav-menu-item" data-section="billing">
            <img src="{{ asset('/img/ico/Billing-Information-ico.svg') }}" alt="" />
            Billing Information
          </a>

          <a href="{{ route('account.profile') }}" class="nav-menu-item" data-section="profile">
