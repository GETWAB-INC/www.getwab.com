            ...
            <div class="register-content">
                <div class="register-header">
                    <h2 class="register-title">Contact Us</h2>
                        ...
                        <form class="register-form" method="POST" action="{{ route('send.message') }}">
                            @csrf
                        ...
                        <div class="form-field">
                            ...
                            <div class="input-wrapper">
                                <input class="form-input" type="email" id="email" name="email" required placeholder="your@company.com">
                            </div>
                        </div>
